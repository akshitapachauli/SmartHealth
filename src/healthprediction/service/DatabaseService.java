...
public class DatabaseService {
    ...
    private void insertSampleData() throws SQLException {
        ...
        if (rsPatients.next() && rsPatients.getInt(1) == 0) {
            ...
            Patient p1 = new Patient("Divya", "Sharma", "divya123@example.com", "983-456-7891",
                                    LocalDate.of(2001, 5, 15), "Female", "Almora, Uttarakhand");
            p1.setExistingConditions("Hypertension");
            p1.setAllergies("Pollen");
            p1.setMedications("Lisinopril");
            savePatient(p1);

            Patient p2 = new Patient("Manan", "Joshi", "manan123@example.com", "735-765-4321",
                                    LocalDate.of(2000, 11, 22), "Male", "Lakhnau, Uttar Pradesh");
            p2.setExistingConditions("None");
            p2.setAllergies("Gluten");
            p2.setMedications("None");
            savePatient(p2);

            Patient p3 = new Patient("Rishu", "Rani", "rr123@example.com", "856-945-2168",
                                    LocalDate.of(2002, 3, 10), "Female", "Delhi, India");
        ...
        if (rsDoctors.next() && rsDoctors.getInt(1) == 0) {
            ...
            d1.setFirstName("Akshita");
            d1.setLastName("Pachauli");
            d1.setEmail("pachauliji123@example.com");
            d1.setSpecialization("Cardiology");
            saveDoctor(d1);

            Doctor d2 = new Doctor();
            d2.setFirstName("Aanchal");
            d2.setLastName("");
            d2.setEmail("aanchal123@example.com");
            d2.setSpecialization("General Medicine");
            saveDoctor(d2);

            Doctor d3 = new Doctor();
            d3.setFirstName("Preeti");
            d3.setLastName("Verma");
            d3.setEmail("preeti123@example.com");
    ...
    public void saveHealthRecord(HealthRecord record) throws SQLException {
        ...
        try (PreparedStatement pstmt = connection.prepareStatement(sql)) {
            ...
            pstmt.setString(15, record.getNotes()); // Add this line
            pstmt.executeUpdate();
        }
    }

    public List<HealthRecord> getHealthRecordsForPatient(int patientId) {
        ...
        try (PreparedStatement pstmt = connection.prepareStatement(sql)) {
            ...
            System.err.println("Error getting health records: " + e.getMessage());
        }
        return records;
    }
