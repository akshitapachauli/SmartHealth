// DatabaseService.java - Database Management Service
...
public class DatabaseService {
    ...
    private static final String DB_URL = "jdbc:sqlite:health_prediction.db"; // Database file in project root
    ...
    public void initializeDatabase() {
        try {
            ...
            createTables();
            insertSampleData(); // Ensures initial data exists
    ...
    private void insertSampleData() throws SQLException {
        ...
        if (rsPatients.next() && rsPatients.getInt(1) == 0) {
            ...
            savePatient(new Patient("John", "Doe", "john.doe@example.com", "123-456-7890",
                                    LocalDate.of(1985, 5, 15), "Male", "123 Main St", "Hypertension", "Pollen", "Lisinopril"));
            savePatient(new Patient("Jane", "Smith", "jane.smith@example.com", "098-765-4321",
                                    LocalDate.of(1992, 11, 22), "Female", "456 Oak Ave", "None", "None", "None"));
            savePatient(new Patient("Alice", "Johnson", "alice.j@example.com", "111-222-3333",
                                    LocalDate.of(1970, 3, 10), "Female", "789 Pine Rd", "Diabetes", "Penicillin", "Metformin"));
        }
        rsPatients.close();
        ...
        if (rsDoctors.next() && rsDoctors.getInt(1) == 0) {
            ...
            saveDoctor(new Doctor("Dr. Sarah", "Smith", "Cardiology", "sarah.s@example.com"));
            saveDoctor(new Doctor("Dr. Alex", "Johnson", "General Medicine", "alex.j@example.com"));
            saveDoctor(new Doctor("Dr. Emily", "White", "Pediatrics", "emily.w@example.com"));
        }
        rsDoctors.close();

        stmt.close();
        // Health records and appointments will be handled by their respective services or GUI interactions
    }
    ...
    public void saveDoctor(Doctor doctor) throws SQLException {
        ...
        try (PreparedStatement pstmt = connection.prepareStatement(sql, Statement.RETURN_GENERATED_KEYS)) {
            ...
            pstmt.setString(13, String.join(",", doctor.getWorkingDays())); // Store as comma-separated string
            pstmt.setInt(14, doctor.isAvailable() ? 1 : 0);
            pstmt.setString(15, doctor.getDepartment());
            pstmt.setString(16, doctor.getBiography());
            pstmt.setString(17, String.join(",", doctor.getLanguages())); // Store as comma-separated string
    ...
    public void updateAppointment(Appointment appointment) throws SQLException {
        ...
        try (PreparedStatement pstmt = connection.prepareStatement(sql)) {
            ...
            pstmt.setDouble(14, appointment.getConsultationFee());
            pstmt.setInt(15, appointment.isEmergency() ? 1 : 0);
            pstmt.setString(16, LocalDateTime.now().toString()); // Update last modified
