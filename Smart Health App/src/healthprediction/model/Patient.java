...
public class Patient {
    ...
    private String existingConditions; // Added field for existing conditions
    private String allergies; // Added field for allergies
    private String medications; // Added field for current medications
